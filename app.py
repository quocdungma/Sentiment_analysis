...
st.sidebar.markdown(f"<h1 style='font-size:17px;'>😊 Tích cực</h1>", unsafe_allow_html=True)
st.sidebar.markdown(f"<h1 style='font-size:17px;'>😐 Trung tính</h1>", unsafe_allow_html=True)
st.sidebar.markdown(f"<h1 style='font-size:17px;'>😢 Tiêu cực</h1>", unsafe_allow_html=True)
